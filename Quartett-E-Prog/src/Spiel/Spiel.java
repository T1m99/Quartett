...
public class Spiel {
	...
	vergleichen(ausw√§hlen(DeckA[i]), MitSpieler1.getPassenderWert(i, Auswahl));
	...
	private static void RundenAbfrage()	// Runden anzahlen ¸berdenken -> muss gerade Anzahl sein.
	...
	private static String passenderName(Karte oben, int Nummer) { // Attribut Namen einf¸gen
		String x ="";
		switch(Nummer) {
		case 1 : 
			x = "Attribut 1";
	...
	private static void karteAnzeigen(Karte aktuell) { // Attribut Namen einf¸gen und schˆner ausgeben.
